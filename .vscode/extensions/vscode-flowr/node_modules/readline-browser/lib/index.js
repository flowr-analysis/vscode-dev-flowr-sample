...
Object.defineProperty(exports, "clearLine", { enumerable: true, get: function () { return utils_1.clearLine; } });
Object.defineProperty(exports, "clearScreenDown", { enumerable: true, get: function () { return utils_1.clearScreenDown; } });
Object.defineProperty(exports, "cursorTo", { enumerable: true, get: function () { return utils_1.cursorTo; } });
Object.defineProperty(exports, "moveCursor", { enumerable: true, get: function () { return utils_1.moveCursor; } });
...
class Interface extends eventemitter2_1.EventEmitter2 {
    ...
    _refreshLine() {
        ...
        if (prevRows > 0) {
            utils_1.moveCursor(this.output, 0, -prevRows);
        }
        // Cursor to left edge.
        utils_1.cursorTo(this.output, 0);
        // erase data
        utils_1.clearScreenDown(this.output);
        ...
        utils_1.cursorTo(this.output, cursorPos.cols);
        const diff = lineRows - cursorPos.rows;
        if (diff > 0) {
            utils_1.moveCursor(this.output, 0, -diff);
        }
    ...
    _tabComplete(lastKeypressWasTab) {
        ...
        this.completer(string, (err, value) => {
            ...
            const prefix = utils_1.commonPrefix(completions.filter((e) => e !== ''));
            ...
            const completionsWidth = completions.map((e) => string_width_1.default(e));
    ...
    _deleteLeft() {
        if (this.cursor > 0 && this.line.length > 0) {
            ...
            const charSize = utils_1.charLengthLeft(this.line, this.cursor);
    ...
    _deleteRight() {
        if (this.cursor < this.line.length) {
            // The number of UTF-16 units comprising the character to the left
            const charSize = utils_1.charLengthAt(this.line, this.cursor);
    ...
    _historyNext() {
        if (this.historyIndex >= 0) {
            const search = this[utils_1.kSubstringSearch] || '';
    ...
    _getDisplayPos(str) {
        ...
        let rows = 0;
        str = utils_1.stripVTControlCharacters(str);
        for (const char of str) {
            ...
            const width = string_width_1.default(char);
            if (width === 0 || width === 1) {
                offset += width;
            }
            else { // width === 2
    ...
    _moveCursor(dx) {
        ...
        if (oldPos.rows === newPos.rows) {
            ...
            utils_1.moveCursor(this.output, diffWidth, 0);
        }
        else {
            this._refreshLine();
        }
        ...
        if (key.ctrl && key.shift) {
            ...
            switch (key.name) {
                ...
                case 'b': // back one character
                    this._moveCursor(-utils_1.charLengthLeft(this.line, this.cursor));
                    break;
                case 'f': // Forward one character
                    this._moveCursor(+utils_1.charLengthAt(this.line, this.cursor));
                    break;
                case 'l': // Clear the whole screen
                    utils_1.cursorTo(this.output, 0, 0);
                    utils_1.clearScreenDown(this.output);
                    this._refreshLine();
                    break;
