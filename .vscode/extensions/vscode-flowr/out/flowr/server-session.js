...
const visitor_1 = require("@eagleoutice/flowr/r-bridge/lang-4.x/ast/model/processing/visitor");
const graph_1 = require("@eagleoutice/flowr/dataflow/graph/graph");
const bimap_1 = require("@eagleoutice/flowr/util/bimap");
class FlowrServerSession {
            ...
            if (configType == 'auto' && this.connection instanceof WsConnection) {
                ...
                void vscode.window.showErrorMessage(`The flowR server connection reported an error: ${e.message}`, openSettings, useLocal)
                    ...
                    if (v === useLocal) {
                        ...
                        void (0, extension_1.establishInternalSession)((0, extension_1.isWeb)() ? 'tree-sitter' : undefined);
                    }
    ...
    async retrieveSlice(criteria, document) {
        const response = await this.requestFileAnalysis(document);
    ...
    async requestFileAnalysis(document, filetoken = '@tmp') {
